...
These days most desktop managers typically have this simple functionality of shuffling the background on intervals. I havent realized what a gift that was up until now. It was bothering me so much because I do not enjoy looking at the same background while on the computer for hours. So I figured that since I am practicing my C++ at the moment, rather than use a simple bash script... I would write a program in C++. 
